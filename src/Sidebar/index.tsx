...
import { MenuItemInterface } from '../models/menuModel';
import { isArrayAndNotEmpty } from '../helper/isArrayAndNotEmpty';
import dashboardIcon from '../images/icon/dashboard-icon.svg'
import DashboardIcon from '../images/icon/dashboard-icon';
        ...
        <nav className="mt-5 py-4 px-4 lg:mt-9 lg:px-6">
          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              {
                menu && isArrayAndNotEmpty(menu) && menu.map((item:MenuItemInterface, index:number) =>{
                  if (isArrayAndNotEmpty(item?.item)) {
